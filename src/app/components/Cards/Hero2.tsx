...
export default async function Hero2() {
  ...
  <div className='flex flex-col justify-center items-center '>
        <text className='text-[#0093F8] text-lg font-bold py-11'>PRODUCTS</text>
...
<div className="mt-28 ">
        <Image src={urlForImage(elm.image).url()} width={400} height={400}alt='sa' className="hover:scale-110 duration-500"/>
