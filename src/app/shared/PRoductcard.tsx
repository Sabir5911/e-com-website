          ...
          <div>
            ...
            <div className="mt-16">
              ...
              <div className="flex gap-x-14 text-2xl mt-5 font-semibold text-[#666]">
                {["XS", "S", "M", "L", "XL"].map((elm) => (
                  <div onClick={()=>handleSize(elm)} className="w-10 h-10 flex justify-center items-center rounded-full  hover:bg-slate-500 scale-105  duration-300 shadow-2xl cursor-pointer ">
                    {elm}
                  </div>
                ))}
              </div>
